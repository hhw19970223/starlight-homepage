...
export function ContactSection() {
  ...
  const cardClass = "flex items-center gap-4 p-6 rounded-2xl bg-card border border-border hover:border-primary/50 hover:shadow-lg transition-all group focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
    ...
    <section id="contact" className="py-20 lg:py-28 px-4 sm:px-8 bg-muted">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          {/* Email Card */}
          <a href={`mailto:${siteConfig.contact.email}`} className={cardClass}>
          ...
          {/* Chat Card */}
          <button className={`${cardClass} text-left`}>
            <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary transition-colors">
